...
```{r}
types.use <- c(
  "Cardiac_Mesoderm","Cardiomyocytes","Definitive_Endoderm",
  "Endocardial","Epicardial","Extraembryonic_Mesoderm",
  "Fibroblasts","Foregut_Epithelium","Liver_Progenitors","Smooth_Muscle"
)
par(mfrow = c(1,1), xpd=TRUE)
netVisual_heatmap(
  scco.chat,
